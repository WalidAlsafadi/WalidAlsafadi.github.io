  ...
  const profileInfo: ProfileInfo = {
    ...
    education: [
      {
        ...
        degree:
          "Bachelor of Science - BS, Data Science and Artificial Intelligence",
        period: "Aug 2022 - Present",
        details: [
          "I continued my journey in Artificial Intelligence and Data Science at UCAS after transferring from AURAK. I served as the Project Manager for the Engineering Club during Fall 2023, though activities were paused due to the war in Gaza. My efforts were recognized with a 30% scholarship for Fall 2023, awarded for outstanding academic performance, including a Spring 2022 grade of 93.26%. Unfortunately, due to interruptions caused by the war in Gaza, my graduation has been delayed to 2026.",
        ],
      },
      {
    ...
    projects: [
      ...
      },
      {
        name: "BBC News",
        description:
          "Self updating dataset. It collects RSS Feeds from BBC News using a Kernel: https://www.kaggle.com/gpreda/bbc-news-rss-feeds. Use the data to analyze the sentiment of news, from title and description.",
      ...
      },
      {
        name: "UFO Sighting",
        description:
          "Perform data analysis on over 80,000 reports of unidentified flying object reports in the last century.",
      ...
      },
      {
        name: "House Prices",
        description:
          "Predict the finale sale price for each house using 79 explanatory variables describing (almost) every aspect of residential homes in Ames, Iowa. ",
      ...
      },
      {
        ...
        githubLink:
          "https://github.com/WalidAlsafadi/Divorce-Predictors-Dataset",
        demoLink: "",
        category: "Machine Learning",
      },
      {
    ...
    technologies: [
      ...
      },
      {
        ...
        icon: <Code className="text-navy-500" />,
        category: "Cloud",
      },
      {
        name: "Git",
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-1">
              <div className="w-40 h-40 md:w-56 md:h-56 mx-auto bg-gradient-to-br from-blue-200 to-blue-400 rounded-full shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                <img
                  src="/PersonalPhoto.jpg" // Replace with your image path
                  alt="Profile"
            ...
            <div className="md:col-span-2 space-y-6 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start space-x-6">
                {(
                  Object.keys(profileInfo.socialLinks) as Array<
                    keyof SocialLinks
                  >
                ).map((platform) => (
                  <a
            ...
            {profileInfo.projects
              .filter(
                (project) =>
                  ...
                  project.category === selectedProjectCategory
              )
              .map((project, index) => (
      ...
      <footer className="bg-white py-6 text-center border-t mt-20">
        <div className="container mx-auto px-4 md:px-6">
          <p className="text-gray-600">
            © {new Date().getFullYear()} {profileInfo.name}. All Rights
            Reserved.
          </p>
        </div>
      </footer>
