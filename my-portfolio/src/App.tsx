...
const Portfolio: React.FC = () => {
  ...
  const profileInfo: ProfileInfo = {
    ...
    summary: "Data Science and Artificial Intelligence Student, specializing in machine learning, deep learning, natural language processing (NLP), and business intelligence. I am passionate about developing innovative AI solutions, leveraging cutting-edge tools such as web scraping, API integration, large language models (LLMs), and more. My expertise spans Python, NLP, machine learning, and deep learning, with proficiency in libraries like TensorFlow, PyTorch, and Keras for tasks such as regression analysis, time series forecasting, text classification, and sentiment analysis. Currently, I am focused on advancing my NLP capabilities, particularly through API integration and preparing these systems for seamless use with large language models like GPT-4 or Llama. I am driven by the goal of contributing to transformative AI solutions and applying data science to solve real-world challenges.",
